...
const
  DefValues: array[0..13] of PChar = ( // unsafe type
    'One=один;два;три;четыре;пять;шесть;семь;восемь;девять;одна;две;ноль',
    'Ten=десять;одиннадцать;двенадцать;тринадцать;четырнадцать;пятнадцать;' +
    'шестнадцать;семнадцать;восемнадцать;девятнадцать',
    'Twen=двадцать;тридцать;сорок;пятдесят;шестдесят;семдесят;восемдесят;девяносто',
    'Hndr=сто;двести;триста;четыреста;пятсот;шестсот;семсот;восемсот;девятсот',
    'Thou=тисяча;тисячи;тисяч',
    'Mill=миллион;милиионы;миллионов',
    'Bill=миллиард;милллиарды;миллиардов',
    ...
    'DayOfWeek=воскресенье;понедельник;вторник;среда;четверг;пятниця;суббота'
  );
